...
var ListsResolver = /** @class */ (function () {
    function ListsResolver(userSerive, router, alertify) {
    ...
    ListsResolver.prototype.resolve = function (route) {
        var _this = this;
        return this.userSerive.getUsers(this.pageNumber.toString(), this.pageSize.toString(), null, this.likesParam).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["catchError"])(function (err) {
...
var MemberDetailResolver = /** @class */ (function () {
    function MemberDetailResolver(userSerive, router, alertify) {
        this.userSerive = userSerive;
        this.router = router;
        this.alertify = alertify;
    }
    MemberDetailResolver.prototype.resolve = function (route) {
        var _this = this;
        return this.userSerive.getUser(route.params.id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["catchError"])(function (err) {
            _this.alertify.error("Problem retrieving data");
...
var MemberEditResolver = /** @class */ (function () {
    function MemberEditResolver(userSerive, authService, router, alertify) {
        this.userSerive = userSerive;
        this.authService = authService;
        this.router = router;
        this.alertify = alertify;
    ...
    MemberEditResolver.prototype.resolve = function (route) {
        ...
        return this.userSerive.getUser(currentUserId).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["catchError"])(function (err) {
...
var MemberListResolver = /** @class */ (function () {
    function MemberListResolver(userSerive, router, alertify) {
        this.userSerive = userSerive;
        this.router = router;
        this.alertify = alertify;
        this.pageNumber = "1";
    ...
    MemberListResolver.prototype.resolve = function (route) {
        var _this = this;
        return this.userSerive.getUsers(this.pageNumber, this.pageSize).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["catchError"])(function (err) {
            _this.alertify.error("Problem retrieving data");
...
var MessagesResolver = /** @class */ (function () {
    function MessagesResolver(userSerive, authService, router, alertify) {
        this.userSerive = userSerive;
        this.authService = authService;
        this.router = router;
        this.alertify = alertify;
    ...
    MessagesResolver.prototype.resolve = function (route) {
        ...
        return this.userSerive.getMessages(userId, this.pageNumber, this.pageSize, this.messageContainer).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["catchError"])(function (err) {
...
var AlertifyServiceService = /** @class */ (function () {
    function AlertifyServiceService() {
    }
    AlertifyServiceService.prototype.confirm = function (message, okCallback) {
    ...
    AlertifyServiceService.prototype.success = function (message) {
        alertify.success(message);
    };
    AlertifyServiceService.prototype.error = function (message) {
        alertify.error(message);
    };
    AlertifyServiceService.prototype.warning = function (message) {
        alertify.warning(message);
    };
    AlertifyServiceService.prototype.message = function (message) {
    ...
    AuthService.prototype.login = function (model) {
        ...
        return this.http.post(this.baseUrl + "login", model).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (response) {
            ...
            if (user) {
                ...
                _this.currentUser = user.currentUser;
    ...
    ErrorInterceptor.prototype.intercept = function (req, next) {
        return next.handle(req).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (error) {
            if (error instanceof _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpErrorResponse"]) {
                ...
                var typeServerError = typeof error.error;
                var modelStateErrors = '';
                var serverError = typeServerError === "string" ? error.error : error.error && error.error.errors;
...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.getUsers = function (page, itemsPerPage, userParams, likeParams) {
        var paginatedResult = new _models_Pagination__WEBPACK_IMPORTED_MODULE_6__["PaginatedResult"]();
    ...
    UserService.prototype.getMessages = function (userId, page, itemsPerPage, messageContainer) {
        ...
        return this.http.get(this.baseUrl + "users/" + userId + "/messages", { observe: "response", params: params }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (response) {
            paginatedResult.result = response.body;
            if (!!response.headers.get('Pagination'))
                paginatedResult.pagination = JSON.parse(response.headers.get('Pagination'));
            return paginatedResult;
...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.cancelRegisterMode = function (cancelRegister) {
...
var ListsComponent = /** @class */ (function () {
    function ListsComponent(route, authService, userService, alertify) {
        this.route = route;
        this.authService = authService;
    ...
    ListsComponent.prototype.ngOnInit = function () {
        ...
        }, function (err) { return _this.alertify.error(err); });
    ...
    ListsComponent.prototype.loadUsers = function () {
        var _this = this;
        this.userService.getUsers(this.pagination.currentPage.toString(), this.pagination.itemsPerPage.toString(), null, this.likesParams).subscribe(function (res) {
...
var MemberEditComponent = /** @class */ (function () {
    ...
    MemberEditComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.route.data.subscribe(function (data) { return _this.user = data.user; }, function (err) { return _this.alertify.error(err); });
    ...
    MemberEditComponent.prototype.updateUser = function () {
        var _this = this;
        var userId = this.authService.decodeToken.nameid;
        this.userService.updateUser(userId, this.user).subscribe(function (next) {
...
var MemberListComponent = /** @class */ (function () {
    ...
    MemberListComponent.prototype.loadUsers = function () {
        var _this = this;
        this.userService.getUsers(this.pagination.currentPage.toString(), this.pagination.itemsPerPage.toString(), this.userParams).subscribe(function (res) {
            _this.users = res.result;
            _this.pagination = res.pagination;
        }, function (err) { return _this.alertify.error(err); });
    };
...
var MemberMessagesComponent = /** @class */ (function () {
    ...
    MemberMessagesComponent.prototype.loadMessages = function () {
        ...
        this.userService.getMessageThread(currentUserId, this.recipientId)
            ...
            .subscribe(function (messages) { return _this.messages = messages; }, function (err) { return _this.alertify.error(err); });
    };
    MemberMessagesComponent.prototype.sendMessage = function () {
        var _this = this;
        this.newMessage.recipientId = this.recipientId;
        this.userService.sendMessage(this.authService.decodeToken.nameid, this.newMessage).subscribe(function (message) {
...
var PhotoEditorComponent = /** @class */ (function () {
    ...
    PhotoEditorComponent.prototype.setMainPhoto = function (photo) {
        var _this = this;
        this.userService.setMainPhoto(this.authService.decodeToken.nameid, photo.id).subscribe(function () {
    ...
    PhotoEditorComponent.prototype.deletePhoto = function (photo) {
        var _this = this;
        this.alertify.confirm("Please confirm photo deletion", function () {
            _this.userService.deletePhoto(_this.authService.decodeToken.nameid, photo.id).subscribe(function () {
                var removeIndex = _this.photos.findIndex(function (p) { return p.id == photo.id; });
                _this.photos.splice(removeIndex, 1);
                _this.alertify.success("Photo as been deleted successfully");
            }, function (err) { return _this.alertify.error(err); });
        });
    };
...
var MessagesComponent = /** @class */ (function () {
    ...
    MessagesComponent.prototype.loadMessages = function () {
        var _this = this;
        this.userService.getMessages(this.authService.decodeToken.nameid, this.pagination.currentPage, this.pagination.itemsPerPage, this.messageContainer).subscribe(function (res) {
    ...
    MessagesComponent.prototype.deleteMessage = function (id) {
        var _this = this;
        this.alertify.confirm("Are you sure you want to remove this message?", function () {
            _this.userService.deleteMessage(id, _this.authService.decodeToken.nameid).subscribe(function () {
                var removedIndex = _this.messages.findIndex(function (message) { return message.id === id; });
                _this.messages.splice(removedIndex, 1);
                _this.alertify.success("Message deleted sucessfully");
            }, function (err) { return _this.alertify.error(err); });
        });
    };
...
var NavbarComponent = /** @class */ (function () {
    function NavbarComponent(authService, alertifyService, router) {
        this.authService = authService;
    ...
    RegisterComponent.prototype.register = function () {
        ...
        if (this.registerForm.valid) {
            ...
            this.authService.register(this.user).subscribe(function () {
                _this.alertifyService.success("Registration successfully");
            }, function (err) { return _this.alertifyService.error(err); }, function () { return _this.authService.login(_this.user).subscribe(function () {
                _this.router.navigate(['/members']);
            }); });
        }
    };
...
var ValueComponent = /** @class */ (function () {
    ...
    ValueComponent.prototype.getValues = function () {
        ...
        this.http.get('http://localhost:5000/api/values')
            .subscribe(function (values) { return _this.values = values; }, function (err) { return console.error(err); });
    };
